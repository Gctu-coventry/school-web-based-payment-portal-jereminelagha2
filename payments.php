                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="date" class="form-control" placeholder="mmddyyyy" aria-label="mydate" aria-describedby="basic-addon1">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" value="101111334401" class="form-control" placeholder="From Account Number" aria-label="fromacc" aria-describedby="basic-addon1">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="To Account Number" aria-label="toacc" aria-describedby="basic-addon1">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text bg-primary text-white">GHS</span>
                        </div>
                    ...
                    <button type="button" class="btn btn-success btn-icon-text">
                            <i class="mdi mdi-file-check btn-icon-prepend"></i> Pay </button>
